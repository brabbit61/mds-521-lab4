...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_jenitjai>
...
<https://brabbit61.github.io/mds-521-lab4/>
...
paste0("The echo argument decides whether to add source code in the output document, since the current value is FALSE, we see only the rendered output in the final document")
...
paste0("The echo argument decides whether to add source code in the output document.")
paste0("The 'highlight' flag highlights code syntax when set to TRUE. Since it is set to FALSE for this example, we cannot see any special colors in this code chunk")
```
